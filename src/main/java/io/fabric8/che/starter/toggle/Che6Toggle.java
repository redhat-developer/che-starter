...
@Component
public class Che6Toggle {
    private static final Logger LOG = LoggerFactory.getLogger(Che6Toggle.class);

    private static final String APP_NAME = "che-starter";
    private static final String FEATURE_NAME = "migrate.to.che6";
